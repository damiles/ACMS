...
class PagesController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticate users
				'actions'=>array('index','logout','pages','updatePage','createPage',
                                                'deletePage'),
				'users'=>User::usernamesByRole((User::ADMIN | User::GESTOR), User::PERM_PAGINAS),
			),
	...
	public function actionCreatePage()
	{
        ...
        if($model->save()){
	        ...
	        $this->redirect(array('updatePage','id'=>$model->idArticle));
        }else{
        	$this->redirect(array('index'));
        }
	}
