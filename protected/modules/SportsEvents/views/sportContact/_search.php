...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'idSportContact'); ?>
		<?php echo $form->textField($model,'idSportContact'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'mainland'); ?>
		<?php echo $form->textField($model,'mainland',array('size'=>60,'maxlength'=>255)); ?>
	</div>
