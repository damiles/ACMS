<div class="titular2 titularEntrenamiento" >
                                    Semana<span><?php echo $index+1 ?></span>
                                </div>
								<div class="tabla_content" style="page-break-after: always;margin-bottom:60px;">     
...
//            $mesActividad=date_format($fecha, 'n');
            $fecha=getDate(strtotime($_REQUEST['date'].' -'.((int)$diasEntrenamiento-(int)$ndia-(7*$index)).' day '));
