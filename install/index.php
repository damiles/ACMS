 ...
 */
 ...
 // TODO Comprobar directorio runtime con permisos de escritura.
 // TODO Comprobar directorio assets con permisos de escritura.
 // TODO Comprobar directorio upload con permisos de escritura.
 // TODO Detectar automáticamente el directorio de subida upload.
...
$requirements = array(
   ...
   /* array(
	...
	array(
		...
		''),
	array(
		t('yii','Runtime dir writable'),
		true,
		check_is_writable(dirname(__FILE__).'/../protected/runtime'),
		'',
		'',		
	),
	array(
		t('yii','Admin runtime dir writable'),
		true,
		check_is_writable(dirname(__FILE__).'/../protected/admin/runtime'),
		'',
		'',		
	),
	array(
		t('yii','Assets dir writable'),
		true,
		check_is_writable(dirname(__FILE__).'/../assets'),
		'',
		'',		
	),
	array(
		t('yii','Upload dir writable'),
		true,
		check_is_writable(dirname(__FILE__).'/../upload'),
		'',
		'',		
	),
	array(
		t('yii','Config dir writable'),
		true,
		check_is_writable(dirname(__FILE__).'/../protected/config'),
		'',
		'',		
	),
...
function check_is_writable($name){
...
//Ahora solo vamos a soportar esp
$lang="es";
$viewFile=dirname(__FILE__)."/views/$lang/index.php";
//$viewFile=dirname(__FILE__)."/views/es/index.php";
if(!is_file($viewFile))
