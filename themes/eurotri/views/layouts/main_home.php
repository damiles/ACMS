...
<head>
	...
	<meta name="language" content="<?php echo YII::app()->getLanguage()?>" />
       ...
       <?php $this->widget('OpenGraphFacebook', 
        ...
        <link href="http://fast.fonts.com/cssapi/d6c4e510-9f9f-43b9-a6d3-0aae33be7fb8.css" rel="stylesheet" type="text/css" />
...
<!-- Fin accesp comunidad -->
	<div id="wrapper">
		<div id="header">
			<h1><a href="index.php" id="logo"><?php echo CHtml::encode(Yii::app()->name); ?></a></h1>
	        	<div id="topmenu">
...
$et=microtime(true);
$dt=$et-$st;
echo "<span style='display:none'>$dt</span>";
?>	
